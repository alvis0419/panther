...
#define CONFIG_PANTHER_MTD_SIZE 0
#endif
...
#define MTDPART_CDB_SIZE           0x00010000
#if defined(CONFIG_PANTHER_BACKUP_IMAGE_BUILD)
    #define MTDPART_LINUX_OFS          (CONFIG_PANTHER_MTD_SIZE - CONFIG_PANTHER_BACKUP_SIZE)
    #define MTDPART_LINUX_SIZE         0x00200000
    #define MTDPART_ROOTFS_OFS         (MTDPART_LINUX_OFS + MTDPART_LINUX_SIZE)
    #define MTDPART_ROOTFS_SIZE        (CONFIG_PANTHER_BACKUP_SIZE - MTDPART_LINUX_SIZE)
    #define MTDPART_FIRMWARE_OFS       (MTDPART_CDB_OFS + MTDPART_CDB_SIZE)
    #define MTDPART_FIRMWARE_SIZE      (CONFIG_PANTHER_MTD_SIZE - CONFIG_PANTHER_BACKUP_SIZE - MTDPART_FIRMWARE_OFS - MTDPART_RWFS_SIZE)
#else
    #define MTDPART_LINUX_OFS          (MTDPART_CDB_OFS + MTDPART_CDB_SIZE)
    #define MTDPART_LINUX_SIZE         0x00200000
    #define MTDPART_ROOTFS_OFS         (MTDPART_LINUX_OFS + MTDPART_LINUX_SIZE)
    #define MTDPART_ROOTFS_SIZE        (CONFIG_PANTHER_MTD_SIZE - CONFIG_PANTHER_BACKUP_SIZE - MTDPART_ROOTFS_OFS - MTDPART_RWFS_SIZE)
    ...
    #define MTDPART_RWFS_SIZE          (CONFIG_PANTHER_MTD_SIZE - CONFIG_MTD_RWPART_EXTRA_PARTITION_OFFSET - CONFIG_PANTHER_BACKUP_SIZE)
#else
    #define MTDPART_RWFS_SIZE          0
#endif
#ifndef CONFIG_PANTHER_BACKUP_IMAGE
    #define CONFIG_PANTHER_BACKUP_SIZE 0
#endif
...
static struct i2c_gpio_platform_data gi2c_bus_data = {
	.sda_pin = CONFIG_PANTHER_GI2C_SDA_GPIO_NUM,
	.scl_pin = CONFIG_PANTHER_GI2C_SCL_GPIO_NUM,
	.udelay  = 20,
	.timeout = 100,
	.scl_is_output_only = 1,
};
...
#endif
#if defined(CONFIG_PANTHER_SND_PCM1)
